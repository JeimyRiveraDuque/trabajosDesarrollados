...
namespace JuegoMemoria
{
    ...
    {
        string nombre_juegador;
        private int m, s;
        int TamanioColumnasFilas = 5;
        ...
        public Facil(string nombre)
        {
            InitializeComponent();
            nombre_juegador = nombre;
            iniciarJuego();
        }
        private void Juego_Load(object sender, EventArgs e)
        {
            saludo.Text += nombre_juegador;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            lblTiempo.Text = "00:" + m + ":" + s;
            if ( m == 3)
            {
                MessageBox.Show("Perdiste, tiempo se acabo");
            }
        ...
        public void iniciarJuego()
        {
            ...
            {
                var Porcentaje = 109f / (float)TamanioColumnasFilas - 10;
            ...
            for (var i = 0; i < TamanioColumnasFilas; i++)
            {
                for (var j = 0; j < TamanioColumnas; j++)
                {
                    ...
                    CartasJuego.Image = Properties.Resources.princi;
            ...
            if (CartasSeleccionadas.Count < 2)
            {
                ...
                if (CartasSeleccionadas.Count == 2)
                {
                    ...
                    else
                    {
                        ...
                        {
                            timer1.Stop();
                            MessageBox.Show("Felicidades terminaste el juego en menos tiempo");
                        }
                        CartaTemporal1.Visible = false; CartaTemporal2.Visible = false;
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            {
                CartaTemporal1.Image = Properties.Resources.princi;
                CartaTemporal2.Image = Properties.Resources.princi;
                CartasSeleccionadas.Clear();
                TiempoVirarCarta = 0;
                timer2.Stop();
            }
